...
if len(sys.argv) < 2:
	print text_colors.words + \
		"\n***** ERROR *****\nSearch for only one word for each time.\n<USAGE: sheltran <a word want to search>\n" \
...
# Read the content. Generated by requested word.
content = urllib2.urlopen(generate_link_for_word).read().decode("utf8",'replace')
